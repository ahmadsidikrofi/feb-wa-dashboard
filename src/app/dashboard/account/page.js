            ...
            <main className="max-w-3xl mx-auto py-12 px-6 lg:px-8 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
                ...
                <div className="space-y-10">
                    ...
                    <section className="space-y-0 divide-y divide-border border-t border-border">
                        ...
                        {/* Connected Accounts */}
                        <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 backdrop-blur-sm overflow-hidden shadow-sm my-7">
                            {/* Header */}
                            <div className="px-5 py-4 border-b border-gray-200 dark:border-white/10">
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Akun Terhubung</h3>
                            ...
                            <div className="px-5 py-4">
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        {/* Google Icon */}
                                        <div className="w-9 h-9 rounded-lg bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/10 flex items-center justify-center shrink-0">
                                        ...
                                        <div>
                                            ...
                                            {linkedEmail ? (
                                                <p className="text-xs text-gray-500 dark:text-white/50 mt-0.5">{linkedEmail}</p>
                                            ) : (
                                                <p className="text-xs text-gray-500 dark:text-white/50 mt-0.5">Login dengan Google</p>
                                            )}
                                        </div>
                                    </div>
