...
import { List, Search, Filter, User, Calendar, Clock, Ticket, Ellipsis, Eye, HandHelpingIcon } from 'lucide-react'
...
export default function TicketArchivePage() {
    ...
    const handleTicketClick = (conversationId) => {
      router.push(`/dashboard/ticket/${conversationId}`)
    }
                  ...
                  filteredTickets.map((ticket) => (
                    <TableRow key={ticket.id}>
                      ...
                      <TableCell>
                        ...
                        >
                          {ticket.status === 'resolved' ? 'Lihat' : 'Tangani'}
                        </Button> */}
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                            ...
                            {ticket.status === 'resolved' || ticket.status === 'in_progress' ? '' : (
                              <DropdownMenuItem><HandHelpingIcon /> Tangani</DropdownMenuItem>
                            )}
                          </DropdownMenuContent>
                        </DropdownMenu>
